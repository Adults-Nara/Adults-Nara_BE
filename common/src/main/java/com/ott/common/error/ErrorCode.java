...
public enum ErrorCode {
    ...
    UPLUS_PHONE_NOT_FOUND("UPLUS-404-002", 404, "U+ 가입되지 않은 번호입니다."),        // 추가
    UPLUS_PHONE_USER_MISMATCH("UPLUS-404-003", 404, "가입 정보를 찾을 수 없습니다."),   // 추가
    UPLUS_INVALID_PHONE("UPLUS-400-002", 400, "올바르지 않은 전화번호 형식입니다."),    // 추가
