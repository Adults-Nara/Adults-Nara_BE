...
public class WatchHistoryApiController {
    ...
    public ApiResponse<?> updateWatchPosition(
        ...
        watchHistoryService.updateWatchPosition(Long.parseLong(userId), videoId, request.getLastPosition(), request.getWatchedSeconds());
    ...
    public ApiResponse<?> stopWatching(
        ...
        watchHistoryService.stopWatching(Long.parseLong(userId), videoId, request.getLastPosition(), request.getWatchedSeconds());
        return ApiResponse.success();
    }
